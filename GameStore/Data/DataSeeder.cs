            ...
            if (!context.Games.Any())
            {
                ...
                var games = new List<Game>
                {
                    ...
                    new Game
                    {
                        ...
                        ImageUrl = "https://cdn.akamai.steamstatic.com/steam/apps/749060/header.jpg",
                    ...
                    new Game
                    {
                        ...
                        ImageUrl = "https://cdn.akamai.steamstatic.com/steam/apps/1511920/header.jpg",
                    ...
                    new Game
                    {
                        ...
                        ImageUrl = "https://cdn.akamai.steamstatic.com/steam/apps/1382380/header.jpg",
                    ...
                    new Game
                    {
                        ...
                        CostPrice = 12.50m,
                        MinStockThreshold = 15,
                        ImageUrl = "https://cdn.akamai.steamstatic.com/steam/apps/1151640/header.jpg",
                    ...
                    new Game
                    {
                        ...
                        CostPrice = 17.50m,
                        MinStockThreshold = 20,
                        ImageUrl = "https://cdn.akamai.steamstatic.com/steam/apps/1403370/header.jpg",
                    ...
                    new Game
                    {
                        ...
                        ImageUrl = "https://cdn.akamai.steamstatic.com/steam/apps/1089350/header.jpg",
                    ...
                    new Game
                    {
                        ...
                        CostPrice = 27.50m,
                        MinStockThreshold = 20,
                        ImageUrl = "https://cdn.akamai.steamstatic.com/steam/apps/1147560/header.jpg",
                        CategoryId = categories.First(c => c.Name == "Strategy").Id,
                        SupplierId = suppliers.First(s => s.Name == "GameTech Studios").Id,
